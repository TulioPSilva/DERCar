...
#Imagens:
img_arranjo_simu = Image.open(r"arranjo_simu.png")
img_iee8500 = Image.open(r"ieee8500.png")
img_trend_carregamento = Image.open(r"trand_c.png")
img_trend_injecao = Image.open(r"trand_j.png")
img_trend_legenda = Image.open(r"trend_legenda.png")
img_screen1 = Image.open(r"Screen1.png")
