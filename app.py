...
#Imagens:
img_arranjo_simu = Image.open("arranjo_simu.png", 'rb')
img_iee8500 = Image.open("ieee8500.png", 'rb')
img_trend_carregamento = Image.open("trand_c.png", 'rb')
img_trend_injecao = Image.open("trand_j.png", 'rb')
img_trend_legenda = Image.open("trend_legenda.png", 'rb')
img_screen1 = Image.open("Screen1.png", 'rb')
...
from PIL import Image
image = Image.open("logo__car.png", 'rb')
